    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProfileAttachments", x => new { x.ProfileId, x.AttachmentId });
                    table.ForeignKey(
                        name: "FK_ProfileAttachments_Attachments_AttachmentId",
                        column: x => x.AttachmentId,
                        principalTable: "Attachments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProfileAttachments_UserProfiles_ProfileId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProfileAttachments_AttachmentId",
